...
//	KEYPAD_PORT = 0xFF;
	GPIO_PinConfig_t PinCfg2;

	PinCfg2.GPIO_PinNumber = R0;
	PinCfg2.GPIO_MODE = GPIO_MODE_OUTPUT_PP;
	PinCfg2.GPIO_Output_Speed = GPIO_SPEED_10M;
	MCAL_GPIO_Init(KEYPAD_PORT, &PinCfg2);

	PinCfg2.GPIO_PinNumber = R1;
	PinCfg2.GPIO_MODE = GPIO_MODE_OUTPUT_PP;
	PinCfg2.GPIO_Output_Speed = GPIO_SPEED_10M;
	MCAL_GPIO_Init(KEYPAD_PORT, &PinCfg2);

	PinCfg2.GPIO_PinNumber = R2;
	PinCfg2.GPIO_MODE = GPIO_MODE_OUTPUT_PP;
	PinCfg2.GPIO_Output_Speed = GPIO_SPEED_10M;
	MCAL_GPIO_Init(KEYPAD_PORT, &PinCfg2);

	PinCfg2.GPIO_PinNumber = R3;
	PinCfg2.GPIO_MODE = GPIO_MODE_OUTPUT_PP;
	PinCfg2.GPIO_Output_Speed = GPIO_SPEED_10M;
	MCAL_GPIO_Init(KEYPAD_PORT, &PinCfg2);

	PinCfg2.GPIO_PinNumber = C0;
	PinCfg2.GPIO_MODE = GPIO_MODE_OUTPUT_PP;
	PinCfg2.GPIO_Output_Speed = GPIO_SPEED_10M;
	MCAL_GPIO_Init(KEYPAD_PORT, &PinCfg2);

	PinCfg2.GPIO_PinNumber = C1;
	PinCfg2.GPIO_MODE = GPIO_MODE_OUTPUT_PP;
	PinCfg2.GPIO_Output_Speed = GPIO_SPEED_10M;
	MCAL_GPIO_Init(KEYPAD_PORT, &PinCfg2);

	PinCfg2.GPIO_PinNumber = C2;
	PinCfg2.GPIO_MODE = GPIO_MODE_OUTPUT_PP;
	PinCfg2.GPIO_Output_Speed = GPIO_SPEED_10M;
	MCAL_GPIO_Init(KEYPAD_PORT, &PinCfg2);

	PinCfg2.GPIO_PinNumber = C3;
	PinCfg2.GPIO_MODE = GPIO_MODE_OUTPUT_PP;
	PinCfg2.GPIO_Output_Speed = GPIO_SPEED_10M;
	MCAL_GPIO_Init(KEYPAD_PORT, &PinCfg2);
