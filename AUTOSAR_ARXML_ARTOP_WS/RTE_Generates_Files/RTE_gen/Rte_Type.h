...
/*********************************************************************
 * component data structure for SWC: DoorLock_indicationSWC 
 *********************************************************************/
typedef struct Rte_CDS_DoorLock_indicationSWC
{
	/* Data Handles section*/
	...
	/* Port API Handles section*/
	/* Inter Runnable Variable API Handles section*/
} Rte_CDS_DoorLock_indicationSWC;

/*********************************************************************
 * component data structure for SWC: Comp_DoorLock_SWC 
 *********************************************************************/
typedef struct Rte_CDS_Comp_DoorLock_SWC
{
	/* Data Handles section*/
	/* Per-Instance Memory Handles section*/
	/* Inter-runnable Variable Handles section*/
